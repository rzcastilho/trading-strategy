defmodule TradingStrategyWeb.CoreComponents do
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    <div class="fieldset mb-2">
      ...
      <.error :for={msg <- @errors} field_id={@id}>{msg}</.error>
    </div>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TradingStrategyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TradingStrategyWeb.Gettext, "errors", msg, opts)
    end
  end
